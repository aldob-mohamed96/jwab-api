...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">
      ...
      <a href="{{ url('shared/groups/show/contracts/'.$group->id.'/valid') }}" class="btn btn-outline-primary m-1">ساري</a>
      <a href="{{ url('shared/groups/show/contracts/'.$group->id.'/invalid') }}" class="btn btn-outline-primary m-1">  منتهي</a>
