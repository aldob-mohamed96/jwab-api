...
class DriverController extends Controller
{
    public function show_driver($state = null)
    {
        ...
        if (Auth::user()->isAbleTo('driver_data') && ($state === 'active' || $state === 'waiting' || $state === 'blocked' || $state === 'pending')) {
            $drivers = DB::select('select driver.id, driver.name, driver.phone , driver.ssd , driver.state, vechile.vechile_type, vechile.made_in, vechile.plate_number, driver.add_date, admins.name as admin_name,
